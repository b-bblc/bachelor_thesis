...
\textbf{(2) Part-of-speech distribution (8 features):} Normalised proportions of major word classes within each EDU:
\begin{itemize}
...
\subsection{Visualisation and Reporting Framework}
...
Automated report generation produces comprehensive analysis summaries in Markdown format through Jupyter Notebooks (\texttt{edu\_boundary\_detection.ipynb} and \texttt{comprehensive\_multilingual\_analysis.ipynb}). Reports include an executive summary with key findings and statistical significance tests, data quality assessment (parsing success rates, feature completeness, outlier analysis), cross-linguistic comparative analysis with effect sizes, clustering results with validation metrics and linguistic interpretation, and a visualisation gallery with embedded plots and captions.
